...
export const translations = {
    ...
    si: {
        ...
        sectionOne: {
            ...
            subtitle: "ශ්‍රී ලංකාව නැවත ගොඩනැගීම සඳහා රු. බිලියන 122 කට අධික මුදලක් පොරොන්දු විය.",
            chart: {
                eu: "යුරෝපා සංගමය",
        ...
        sectionTwo: {
            ...
            subtitle: "ලැබුණු රු. බිලියන 122 න් අඩකට ආසන්න ප්‍රමාණයක් අතුරුදහන් විය. මේ 2007 මුදල් අගයෙන්! අද එහි වටිනාකම ගැන සිතා බලන්න!",
            statLabelOne: "වියදම් කළ මුදල",
            statLabelTwo: "ගිණුම්ගත නොකළ",
            totalLabel: "ලැබුණු මුළු ආධාර",
            source: "ට්‍රාන්ස්පේරන්සි ඉන්ටර්නැෂනල් ශ්‍රී ලංකා (2007)"
        },
        sectionThree: {
            title: "පොරොන්දුව සහ යථාර්ථය",
            subtitle: "ඔවුන් සතුව මුදල් තිබුණි (රු. බිලියන 122). එසේ නම් මිනිසුන් තවමත් කූඩාරම් වල සිටියේ ඇයි?",
            chart: {
