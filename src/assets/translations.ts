...
export const translations = {
    ...
    si: {
        hero: {
            ...
            cta: "අපි නම් රට හදුවෙ මෙහෙමයි, අපේ හාමුදුරුවනේ."
        },
        sectionOne: {
            title: "උදව් පොරොන්දු වූයේ කවුද?",
            subtitle: "ශ්‍රී ලංකාව නැවත ගොඩනැගීම සඳහා රු. බිලියන 122 කට අධික මුදලක් දානපතීන් පොරොන්දු විය.",
            chart: {
                eu: "යුරෝපා සංගමය",
                ngo: "පෞද්ගලික / NGO",
                japan: "ජපානය",
        ...
        sectionTwo: {
            ...
            subtitle: "ලැබුණු රු. බිලියන 122 න් අඩකට ආසන්න ප්‍රමාණයක් අතුරුදහන් විය. මෙය සියල්ල 2007 දී! උද්දමනයත් සමග අද එහි වටිනාකම කෙතරම් විය හැකිදැයි සිතා බලන්න!",
            statLabelOne: "වියදම් කළ",
            statLabelTwo: "යාගිය අතක් නැති",
            totalLabel: "ලැබුණු මුළු ආධාර",
            source: "ට්‍රාන්ස්පේරන්සි ඉන්ටර්නැෂනල් ශ්‍රී ලංකා (2007)"
        },
        sectionThree: {
            title: "පොරොන්දුව සහ යථාර්ථය",
            subtitle: "ඔවුන් සතුව මුදල්  (රු. බිලියන 122ක්) තිබුණි. එසේ නම් මිනිසුන් තවමත් කූඩාරම් වල සිටියේ ඇයි?",
            chart: {
            ...
            actualLabel: "සැබෑ නිම කිරීම (වසරකට පසු)",
            actualNote: "2005 අවසානයේ නිම කර තිබුණේ නිවාස ~13,000 පමණි",
            source: "UNOCA Report (2005)"
        },
        sectionFour: {
            title: "\"HELPING HAMBANTHOTA\" වංචාව",
            subtitle: "ආපදා සහනයක්ද... නැත්නම් පුද්ගලික සහනයක්ද?",
            desc: "2005 දී, විමර්ශනවලින් හෙළි වූයේ රු. මිලියන 82.9 ක මුදලක් මහා භාණ්ඩාගාරයෙන් ඉවත් කර අගමැතිවරයාගේ පාලනය යටතේ පැවති පුද්ගලික ගිණුමකට බැර කළ බවයි.",
            chart: {
                treasury: "මහා භාණ්ඩාගාරය (නීත්‍යානුකූල)",
                private: "HELPING HAMBANTHOTA (පුද්ගලික)"
            },
            quote: "\"මෙම මුදල් පුද්ගලික ගිණුමකට මාරු කිරීම සාපරාධී සාවද්‍ය පරිහරණයකි.\"",
            quoteAuthor: "— මූලික පොලිස් වාර්තාව (CID)",
            source: "BBC: 'Helping Hambantota' probe halted",
            cjApology: "මම මෑතකදී නාරාහේන්පිට පොළේදී JVP සාමාජිකයෙකු හමු වූ විට ඔහු මගෙන් ඇසුවා ඇයි මම 2005 දී නිවැරදි තීන්දුව ලබා නොදුන්නේ කියා, මට ඔහුට පිළිතුරක් දීමට නොහැකි විය. නමුත් අද මම ඒ ගැන සමාව අයදිනවා. මට ඉතා කණගාටුයි,",
            cjName: "සරත් එන්. සිල්වා",
            cjContext: "හිටපු අගවිනිසුරු (විමර්ශනය නතර කරමින් 2005 දී ලබා දුන් තීන්දුව ගැන සඳහන් කරමින්)",
        },
        sectionFive: {
            title: "\"කාර්යක්ෂමතාවයේ\" මිථ්‍යාව",
            subtitle: "නාමල්: \"අපි දිහා බලන්න.\" යථාර්ථය: මාස 9 කට පසුවත් මුදල් තවමත් බැංකු වල කුණු වෙමින් තිබුණි.",
            chart: {
                spent: "විපතට පත් වූවන් සඳහා වියදම් කළ ආධාර",
                idle: "නිෂ්ක්‍රීයව / බැංකු වල හිර වූ ආධාර"
            },
            alertTitle: "අකාර්යක්ෂමතාවයේ හානිය:",
            alertDesc: "මුදල් නිෂ්ක්‍රීයව තිබියදී, ආහාර සහ ඖෂධ කන්ටේනර් 686 ක් කොළඹ වරායේ අතහැර දමා තිබූ බව විගණකාධිපතිවරයා සොයා ගන්නා ලදී",
            source: "Auditor General S.C. Mayadunne: Interim Tsunami Aid Audit (2005)"
        },
        sectionSix: {
            title: "\"රාජපක්ෂ මාදිලිය\" ලකුණු පත",
            subtitle: "නාමල් කියන්නේ ඔවුන්ව ආදර්ශයට අපි එයට ලකුණු දැමුවෙමු.",
            headers: {
                metric: "මිනුම",
                finding: "තත්වය",
                grade: "ශ්‍රේණිය"
            ...
            rows: {
                transparency: {
                    name: "විනිවිදභාවය",
                    desc: "ආධාර වලින් 45% ක් (රු. බිලියන 53.6) අතුරුදහන්",
                    grade: "F"
                },
                efficiency: {
                    name: "කාර්යක්ෂමතාවය",
                    desc: "මුදල් වලින් 86.5% ක් නිෂ්ක්‍රීයයි; කන්ටේනර් 686 ක් අතහැර දමයි",
                    grade: "F"
                },
                execution: {
                    name: "ව්‍යාපෘති",
                ...
                politics: {
                    name: "දේශපාලනය",
                    desc: "විපාක නැත. සොරකම හෙලිව තිබියදීම මාස 2 කට පසු මහින්ද ජනාධිපති බවට පත් විය.",
                    grade: "A+"
                }
            },
        ...
        footer: {
            ...
            punchline: "අපි තමා හොඳටම කලේ!",
            legal: "මූලාශ්‍ර: විගණකාධිපති, NGO වාර්තා සහ ශ්‍රේෂ්ඨාධිකරණ වාර්තා. මෙය පොදු ජන යහපත උදෙසා කළ හෙළිදරව්වකි."
        },
        sectionOffshore: {
            title: "පිටරට සම්බන්ධතාව",
            subtitle: "රට ආධාර යදිද්දී, පවුල රහස් ගිණුම් ජාලයක් තැනුවේය.",
            desc: "සුනාමි ආධාර ගියේ කුමන ගිණුමටදැයි අපට කිසිදා හරියටම සොයාගත නොහැකි වනු ඇත. නමුත් පවුලේ වත්කම් තිබුණේ කොහේදැයි අපි දනිමු.",
            cards: {
                pandora: {
                    title: "පැන්ඩෝරා පත්‍රිකා (2021)",
                    body: "ගුප්ත ලේඛන හෙළි කළේ නිරූපමා රාජපක්ෂ (ඥාති සොහොයුරිය) සහ ඇගේ සැමියා විසින් සැමෝවා සහ BVI හි රහසිගත සමාගම් හරහා මිලියන ගණනක් තබාගත් බවයි."
                },
                assets: {
    ...
    ta: {
        ...
        sectionOne: {
            ...
            subtitle: "இலங்கையை மீண்டும் கட்டியெழுப்ப நன்கொடையாளர்கள் ரூ. 122 பில்லியனுக்கும் அதிகமான தொகையை உறுதியளித்தனர்.",
            chart: {
        ...
        sectionTwo: {
            ...
            subtitle: "பெறப்பட்ட ரூ. 122 பில்லியனில், கிட்டத்தட்ட பாதி மறைந்துவிட்டது. இது 2007 ஆம் ஆண்டின் பணமதிப்பில்! இப்போது அதன் மதிப்பு எவ்வளவு என்று கற்பனை செய்து பாருங்கள்!",
            statLabelOne: "செலவிடப்பட்டது",
            statLabelTwo: "கணக்கில் வராதவை",
            totalLabel: "பெறப்பட்ட மொத்த உதவி",
            source: "டிரான்ஸ்பரன்சி இன்டர்நேஷனல் ஸ்ரீலங்கா (2007)"
        },
        sectionThree: {
            title: "வாக்குறுதி மற்றும் யதார்த்தம்",
            subtitle: "அவர்களிடம் பணம் இருந்தது (ரூ. 122 பில்லியன்). அப்படியானால் மக்கள் ஏன் இன்னும் கூடாரங்களில் இருந்தார்கள்?",
            chart: {
        ...
        sectionFour: {
            ...
            source: "BBC: 'Helping Hambantota' probe halted",
            cjApology: "\"சமீபத்தில் நாரஹேன்பிட்ட சந்தையில் ஜேவிபி உறுப்பினர் ஒருவரை சந்தித்தேன், 2005 இல் நான் ஏன் சரியான தீர்ப்பை வழங்கவில்லை என்று அவர் என்னிடம் கேட்டார், என்னால் அவருக்கு பதிலளிக்க முடியவில்லை. ஆனால் இன்று அதற்காக நான் மன்னிப்பு கோருகிறேன். நான் மிகவும் வருந்துகிறேன்,\"",
            cjName: "சரத் என். சில்வா",
            cjContext: "முன்னாள் பிரதம நீதியரசர் (விசாரணையை நிறுத்தி 2005 இல் வழங்கிய தீர்ப்பு குறித்து)",
        },
        sectionFive: {
